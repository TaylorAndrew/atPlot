...
#'
#' @param ... Plots to be combined together
#' @param plotlist List of plots to be combined together
#' @param file Name for the output file
#' @param cols Number of columns
#' @param layout An x, y coordinate system for laying out the plots
#'
...
multiPlot <-
  function(..., plotlist = NULL, file, cols = 1, layout = NULL) {
    ...
    if (numPlots == 1) {
      ...
      # Set up the page
      grid.newpage()
      # gridExtra::grid.arrange(padding=0)
